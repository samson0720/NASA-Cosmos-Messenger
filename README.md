...
[![Android CI](https://github.com/samson0720/2026-Android-TechFresh-Pre-Assessment/actions/workflows/android-ci.yml/badge.svg)](https://github.com/samson0720/2026-Android-TechFresh-Pre-Assessment/actions/workflows/android-ci.yml)
...
<table>
  ...
  <tr>
    ...
    <td align="center"><b>Offline cache</b><br />網路失敗時回退到本機快取。</td>
  </tr>
</table>
...
| Offline cache | 成功查詢後 cache APOD，網路失敗時 fallback |
...
Android app reads NASA API key and optional Nova Guide endpoint from `local.properties`:
...
If `NASA_API_KEY` is missing, the app falls back to NASA `DEMO_KEY`. `NOVA_GUIDE_ENDPOINT` is optional; APOD query, Favorites, birthday star card, and collage still work without it.
